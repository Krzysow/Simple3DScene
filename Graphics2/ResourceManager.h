...
public:
	...
	shared_ptr<Mesh>							GetMesh(wstring modelName, XMMATRIX orientation, ColliderType colliderType);
...
private:
	...
	shared_ptr<Mesh>							LoadModelFromFile(wstring modelName, XMMATRIX orientation, ColliderType colliderType);
