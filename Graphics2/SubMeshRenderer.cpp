...
void SubMeshRenderer::RenderTransparentNodes(bool renderTransparent)
{
	_renderTransparent = renderTransparent;
}
...
void SubMeshRenderer::Render()
{
	...
	if ((_renderTransparent && opacity < 1.0f) ||
		(!_renderTransparent && opacity == 1.0f))
	{
		...
		cBuffer.Opacity = material->GetOpacity();
