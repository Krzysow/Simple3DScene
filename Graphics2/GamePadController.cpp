...
void GamePadController::ProcessGameController()
{
	...
	DirectXFramework::GetDXFramework()->GetCamera()->SetLeftRight(thumbLX / 5000.0f);
	DirectXFramework::GetDXFramework()->GetCamera()->SetForwardBack(thumbLY / 5000.0f);
	DirectXFramework::GetDXFramework()->GetCamera()->SetYaw(thumbRX / 4000.0f);
	DirectXFramework::GetDXFramework()->GetCamera()->SetPitch(-thumbRY / 4000.0f);
	DirectXFramework::GetDXFramework()->GetCamera()->SetRoll(leftTrigger / 100.0f);
	DirectXFramework::GetDXFramework()->GetCamera()->SetRoll(-rightTrigger / 100.0f);
}
